...
<div class="report">
    <div class="report-content">
        ...
        <div style="font-size: 13.5px; line-height: 1.6; color: #334155; margin-left: 12px; margin-bottom: 25px;">
            ...
            <p><strong>System Timestamp:</strong> <?php date_default_timezone_set('Asia/Kuala_Lumpur'); echo date("d M Y, h:i A"); ?></p>
            <p><strong>Format Export Option:</strong> PDF (Printable Viewport Mode)</p>
        </div>
