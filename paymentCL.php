...
<head>
    ...
    <style>
        ...
        .btn-blue {background:#1E90FF; color:#fff; margin-right:10px;}
        .btn-green {background:#28a745; color:#fff;}
    </style>
</head>
<body>
    <div class="header">Payments - <?php echo $_SESSION['client_name']; ?></div>
    ...
    <div class="content">
        <div class="card">
            ...
            <table>
                ...
                <tr>
                    <td>P01</td><td>A03</td><td>Completed</td><td>25/08/2026</td><td>Online Banking</td>
                </tr>
                <tr>
                    <td>P02</td><td>A02</td><td>Completed</td><td>28/08/2026</td><td>Online Banking</td>
                </tr>
            </table>
            <div class="buttons">
                <button class="btn btn-blue">Make Payment</button>
                <button class="btn btn-green">Download Receipt</button>
            </div>
        </div>
    </div>
</body>
